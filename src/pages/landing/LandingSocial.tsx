      ...
      <section id="about" className="px-6 py-20 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
            ...
            <p>
              Проект начат в 2022 году. В 2024 году запущен в коммерческую эксплуатацию. На сегодняшний день платформой пользуются аграрные холдинги, строительные и охранные организации, а также частные операторы БПЛА.
            </p>
          </div>
          <div className="space-y-3">
            {[
              { label: "Год основания", val: "2022" },
